 ...
 * @license
 * =========================================================
 * foundation-datetimepicker.js
 * http://github.com/dyohi/foundation-datetimepicker
 * =========================================================
 * Copyright 2014 David Oshiro
 *
 * Contributions:
 * - based on http://github.com/Eonasdan/bootstrap-datetimepicker
 * - based on tarruda's datepicker
 * - utilizes Zurb Foundation5, Foundation-Icons-3, moment.js
 *
...
// ReSharper disable once InconsistentNaming
    ...
    icons = {
        ...
        init = function () {
            ...
            if (picker.component) icon = picker.component.find('i');
            ...
            if (picker.options.pickDate && picker.options.pickTime) {
                picker.widget.on('click.togglePicker', '.accordion-toggle', function (e) {
                    ...
                    if (expanded && expanded.length) {
                        ...
                        picker.element.find('.input-group-addon i').toggleClass(picker.options.icons.time + ' ' + picker.options.icons.date);
                    }
                });
            }
            if (picker.isInput) {
    ...
    isInDisableDates = function (date) {
        ...
        getTemplate = function (pickDate, pickTime, collapse) {
            if (pickDate && pickTime) {
                return (
                    '<div class="datetimepicker-widget dropdown-menu" style="z-index:9999 !important;">' +
